...
/** Generated Interface for S_Booking
 *  @author iDempiere (generated) 
 *  @version Release 7.1
 */
@SuppressWarnings("all")
public interface I_S_Booking 
{

    /** TableName=S_Booking */
    public static final String Table_Name = "S_Booking";
    ...
    /** Column name S_Booking_UU */
    public static final String COLUMNNAME_S_Booking_UU = "S_Booking_UU";

	/** Set S_Booking_UU	  */
	public void setS_Booking_UU (String S_Booking_UU);

	/** Get S_Booking_UU	  */
	public String getS_Booking_UU();
